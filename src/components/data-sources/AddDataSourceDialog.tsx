...
import { Plus, Database, Globe, FileText, Zap, Users, BarChart3 } from 'lucide-react';
...
export const AddDataSourceDialog = ({ onAdd, isLoading = false }: AddDataSourceDialogProps) => {
          ...
          <div className="space-y-4">
            <div className="border-2 border-dashed border-border rounded-lg p-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-2">
                File upload will be available after creation
              </p>
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto w-[95vw] sm:w-full">
        <DialogHeader>
          ...
          <DialogDescription>
            Connect a new data source to start collecting and analyzing data.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
